...
Meant to be pointed at the same daily export every day; output path
defaults to "<INPUT>_sd_analyst_german.xlsx" next to the input. The input
...
def main():
    ...
    output_path = Path(sys.argv[2]) if len(sys.argv) >= 3 else \
        input_path.with_name(f"{input_path.stem}_sd_analyst_german.xlsx")
